...
PATH_COMMENTS = DIR_LARGE + "youtube_comments.csv"
...
for chunk in pd.read_json(PATH_METADATA, lines=True, compression="infer", chunksize=10000, nrows=100000):
...
for chunk in pd.read_csv(PATH_COMMENTS,sep=';',usecols = ['author','video_id'],chunksize=1000, nrows=10000):
    ...
    # As long it can fit into memory
